...
(*"1999" + "1";;
Error de tipos ya que es una suma de dos números enteros
 y hay dos strings*)
...
"2" < "12";;
(*- : bool = true *)
(*MAL:  - : bool = false. Porque compara primero el primer
 número entonces la comparación es 2 < 1 *)


"uno" < "dos";;
(*- : bool = true *)
(*MAL:  - : bool = false. Porque compara primero la primera letra por orden alfabético *)
...
(if 3 = 4 then 0 else "4";;)
(* - : string = "4"
MAL: Error de tipos, la expresión "0"  es string y la 4 es int *)
...
f 2 + 1;;
(*La función de doble de dos que es 4 + 1 = 5
- : int =5 *)
...
g 3;;
(*- : int = 8
MAL:  la función g(x) se guarda con n=1, cambiarle el valor 
a n a posteriori no afecta a la funcion de g*)
